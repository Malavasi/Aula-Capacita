<div class="blogforos index">
	...
	<tr>
		<td><?php echo $this->Html->link($blogforo['Curso']['id'], array('controller' => 'cursos', 'action' => 'view', $blogforo['Curso']['id'])); ?></td>
		<td><?php echo $this->Html->link($blogforo['Usuario']['id'], array('controller' => 'usuarios', 'action' => 'view', $blogforo['Usuario']['id'])); ?></td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Eliminar'), array('action' => 'delete', $blogforo['Blogforo']['id']), array(), __('Are you sure you want to delete # %s?', $blogforo['Blogforo']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
	...
	'format' => __('Página {:page} de {:pages}, mostrando {:current} usuarios de {:count}')
	));
	?>	</p>
	<div class="paging">
	<?php
